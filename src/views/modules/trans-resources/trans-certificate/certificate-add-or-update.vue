<template>
  <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="100px">
    ...
    <el-row>
      <el-col :span="8">
        <el-form-item label="运输证号" prop="transportNo">
          <el-input v-model="dataForm.transportNo" @blur="handleTransport" maxlength="30" clearable placeholder="运输证号"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
      ...
      <el-col :span="16">
        <el-form-item label="许可证号" prop="licenceNo">
          <el-input v-model="dataForm.licenceNo" maxlength="30" clearable placeholder="许可证号"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="车牌类型" prop="carType">
          <el-input v-model="dataForm.carType" maxlength="30" clearable placeholder="车牌类型"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="车尺寸(毫米)">
          <el-col :span="8">
            <el-form-item prop="carLong">
              <el-input v-model="dataForm.carLong" maxlength="7" clearable placeholder="长">
          ...
          <el-col :span="8" style="padding-left: 10px">
            <el-form-item prop="carWide">
              <el-input v-model="dataForm.carWide" maxlength="7" clearable placeholder="宽">
          ...
          <el-col :span="8" style="padding-left: 10px">
            <el-form-item prop="carHigh">
              <el-input v-model="dataForm.carHigh" maxlength="7" clearable placeholder="高">
      ...
      <el-col :span="8">
        <el-form-item label="载重(吨)" prop="carLoad">
          <el-input v-model="dataForm.carLoad" maxlength="9" clearable placeholder="载重(吨)"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">
        <el-form-item label="经营范围">
          <el-input v-model="dataForm.manageScope" type="textarea" maxlength="120"  rows="4"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
    ...
    <el-row style="margin-top: 20px;text-align: right">
      <el-col>
        <el-form-item>
          <el-button @click="$router.push({name: 'trans-resources-trans-certificate/certificate'})">取消</el-button>
  ...
  export default {
    data () {
      ...
      return {
        ...
        dataRule: {
          ...
          propertyName: [
            { required: true, message: '请填写业户名称', trigger: 'blur' }
          ],
          appendNumber: [
          ...
          carLoad: [
            {required: false, validator: verifyPositiveNumber, trigger: 'blur'}
          ],
          valueDate: [
    ...
    methods: {
      ...
      handleTransport (event) {
        this.$http({
          url: this.$http.adornUrl(`/transresources/trroadtransportlicence/byTransportNo/${event.target.value}`),
          method: 'get',
          params: this.$http.adornParams()
        }).then(({data}) => {
          if (data && data.code !== 0) {
            this.$message(data.msg)
            this.dataForm.transportNo = ''
          }
        })
      }
    }
