    ...
    <div class="mod-config">
      <el-form :inline="true" :model="dataForm" label-width="100px" @keyup.enter.native="getDataList()">
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="初次验证日期:">
              <span style="width: 200px; display: block">
                {{dataForm.firstCheckTime}}
              </span>
            </el-form-item>
          </el-col>
          <el-col :span="8">
      ...
      getDataList () {
        ...
        this.$http({
          ...
          if (data && data.code === 0) {
            ...
            this.dataForm.isChecked = data.carCheck.isChecked === 0 ? '未验证' : data.carCheck.isChecked === 1 ? '已验证' : ''
