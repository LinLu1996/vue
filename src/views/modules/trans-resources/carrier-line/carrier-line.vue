...
<!--            <xkl-select style="width: 100%" v-model="dataForm.goodSort" keyType="carrierName" labelType="carrierName" linkage="/transresources/trcarrier/noPowerList " placeholder="选择或输入查找"></xkl-select>-->
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <label class="el-form-item__label" v-if="scope.row.isGoodLine== 1">是</label>
          <label class="el-form-item__label" v-if="scope.row.isGoodLine== 0">否</label>
         <!-- <el-switch
  ...
  export default {
    ...
    methods: {
      ...
      handleStatus (val, id) {
        ...
        this.$http({
          url: this.$http.adornUrl('/transresources/trcarrierline/updateIsGoodLineById'),
          method: 'post',
