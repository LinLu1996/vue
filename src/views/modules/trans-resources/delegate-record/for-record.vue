  ...
  <div class="tem-content">
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="100px">
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="委托方名称" prop="consignorId">
            <xkl-select style="width: 100%" v-model="dataForm.consignorId" labelType="ownerName" linkage="/transresources/ttrconsignor/list" placeholder="承运商名称"></xkl-select>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="适用范围" prop="supportRange">
            <el-input v-model="dataForm.supportRange" placeholder="适用范围" maxlength="48" clearable></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="备案时间" prop="recordDtm">
            <el-date-picker
              style="width: 100%"
              v-model="dataForm.recordDtm"
              type="date"
              placeholder="选择日期">
            </el-date-picker>
          </el-form-item>
        ...
        <el-col :span="12">
          <el-form-item label="生效时间" prop="effectDtm">
            <el-date-picker
              style="width: 100%"
              v-model="dataForm.effectDtm"
              type="date"
              placeholder="选择日期">
            </el-date-picker>
          </el-form-item>
      ...
      <el-row style="margin-top: 20px;text-align: right">
        <el-col>
          <el-form-item>
            <el-button @click="$router.push({name: 'trans-resources-delegate-record/record-list'})">取消</el-button>
    ...
    methods: {
      ...
      changeCarrier (type) {
        if (type === 'carrier') {
          ...
          this.$nextTick(() => {
            this.$refs.carrierInfo.init(this.dataForm.carrierIds)
          })
        } else if (type === 'car') {
          ...
          this.$nextTick(() => {
            this.$refs.carInfo.init(this.dataForm.carrierIds, this.dataForm.carIds)
          })
        } else if (type === 'driver') {
          if (!this.dataForm.carrierName) {
            this.$message({
          ...
          this.$nextTick(() => {
            this.$refs.driverInfo.init(this.dataForm.carrierIds, this.dataForm.driverIds)
          })
        }
      },
