  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" label-width="100px">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="身份证反面：" prop="idCardBackAttachment">
            <xkl-upload ref="upload2" v-if="dataForm.idCardFrontAttachment.length" v-model="dataForm.idCardBackAttachment" :config="uploadConfig"></xkl-upload>
          </el-form-item>
        </el-col>
      </el-row>
      <el-form-item label-width="0">
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="领证日期：" prop="certificationTime">
            <span style="width: 200px; display: block">
              {{dataForm.driverLicence.certificationTime}}
            </span>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="有效期至：" prop="validTime">
            <span style="width: 200px; display: block">
              {{dataForm.driverLicence.validTime}}
            </span>
          </el-form-item>
        </el-col>
      </el-row>
