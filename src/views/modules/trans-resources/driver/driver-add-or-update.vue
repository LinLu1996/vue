  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="100px">
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="承运商" prop="carrierId">
            <xkl-select style="width: 100%" v-model="dataForm.carrierId" labelType="carrierName" linkage="/transresources/trcarrier/noPowerList" select-type="OPERATION_TYPE" placeholder="承运商" clearable></xkl-select>
          </el-form-item>
        </el-col>
        <el-col :span="8">
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="领证日期" prop="driverLicence.certificationTime" :rules="dataRule.certificationTime">
            <el-date-picker
        ...
        <el-col :span="8">
          <el-form-item label="有效期至" prop="driverLicence.validTime" :rules="dataRule.validTime">
            <el-date-picker
              style="width: 100%"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="附件" prop="driverLicence.attachments">
