        ...
        <el-col :span="8">
          <el-form-item label="验证状态">
            <el-select v-model="dataForm.isChecked" style="width: 100%;" :clearable="true">
              <el-option key="0" label="未验证" :value="0">
              </el-option>
              <el-option key="1" label="已验证" :value="1">
              </el-option>
            </el-select>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="24" style="text-align: right;padding-right: 5px">
          <el-form-item style="margin-bottom: 5px">
            ...
            <el-button type="success" size="mini"  icon="el-icon-download" @click="outPutExcel">导出</el-button>
              <el-button type="success" size="mini" @click="annualReview">
...
<!--            录入验证-->
<!--          </el-button>-->
          <el-button style="width: 80px" type="primary" size="small" @click="handleResult(scope.row.id)">
            <icon-svg name="detail" style="vertical-align: middle"></icon-svg>
            验证结果
          </el-button>
        </template>
