      ...
      <el-row>
        <el-col :span="24" style="text-align: right;padding-right: 5px">
          <el-form-item style="margin-bottom: 5px">
            ...
            <el-button type="success" size="mini" :disabled="currentStatus !== 0 && currentStatus !== 3" @click="toORBackExamine(2)">
              <icon-svg name="审核" style="vertical-align: middle"></icon-svg>
              审核</el-button>
            <el-button type="success" size="mini" :disabled="currentStatus !== 2" @click="toORBackExamine(0)">
              <icon-svg name="反审核" style="vertical-align: middle"></icon-svg>
              反审核</el-button>
            <el-button type="danger" size="mini" @click="toORBackExamine(4)">
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="{row}">
          ...
          <el-input-number v-else v-model="row.rejectionReport" :max="9999999" :precision="2" :step="0.1" size="mini"></el-input-number>
        </template>
      </el-table-column>
      <el-table-column
        ...
        <template slot-scope="{row}">
          ...
          <el-input-number v-else v-model="row.thermometerBack" :max="9999999" :precision="2" :step="0.1" size="mini"></el-input-number>
        </template>
      </el-table-column>
      <el-table-column
        ...
        <template slot-scope="{row}">
          ...
          <el-input-number v-else v-model="row.rejectReturnsBack" :max="9999999" :precision="2" :step="0.1" size="mini"></el-input-number>
        </template>
      </el-table-column>
      <el-table-column
        ...
        <template slot-scope="{row}">
          ...
          <el-input-number v-else v-model="row.saleWithdrawalBack" :max="9999999" :precision="2" :step="0.1" size="mini"></el-input-number>
        </template>
      </el-table-column>
      <el-table-column
        prop="complaintFine"
        ...
        <template slot-scope="{row}">
          ...
          <el-input-number v-else v-model="row.complaintFine" :max="9999999" :precision="2" :step="0.1" size="mini"></el-input-number>
        </template>
      </el-table-column>
      <el-table-column
        ...
        <template slot-scope="{row}">
          ...
          <el-input-number v-else v-model="row.documentsAccuracy" :max="9999999" :precision="2" :step="0.1" size="mini"></el-input-number>
        </template>
      </el-table-column>
      <el-table-column
        ...
        <template slot-scope="{row}">
          ...
          <el-input-number v-else v-model="row.thermometerLoss" :max="9999999" :precision="2" :step="0.1" size="mini"></el-input-number>
        </template>
      </el-table-column>
      <el-table-column
        prop="carEnsureRate"
        ...
        <template slot-scope="{row}">
          ...
          <el-input-number v-else v-model="row.carEnsureRate" :max="9999999" :precision="2" :step="0.1" size="mini"></el-input-number>
        </template>
      </el-table-column>
      <el-table-column
        prop="reward"
        ...
        <template slot-scope="{row}">
          ...
          <el-input-number v-else v-model="row.reward" :max="9999999" :precision="2" :step="0.1" size="mini"></el-input-number>
        </template>
      </el-table-column>
      <el-table-column
        header-align="center"
        ...
        label="操作">
        <template slot-scope="{ row }">
          <el-button v-show="!row.editing" type="warning" size="small" @click="updateHandle(row)">
            <icon-svg name="编辑" style="vertical-align: middle"></icon-svg>
            编辑</el-button>
          <div v-show="row.editing">
            <el-button size="mini" @click="row.editing = false, getDataList()">取消</el-button>
