      ...
      <el-form ref="dataForm" :inline="true" :model="dataForm" label-width="120px" @keyup.enter.native="getDataList()">
        ...
        <el-row>
          <el-col style="text-align: right">
            <el-button type="success" size="mini" style="margin-bottom: 5px"  icon="el-icon-download" @click="outPutExcel">导出</el-button>
          </el-col>
        </el-row>
      </el-form>
      <el-table
      ...
      getDataList () {
        ...
        this.$http({
          ...
          if (data && data.code === 0) {
            ...
            this.dataForm.statementMonth = JSON.stringify(data.page.values) !== '{}' ? data.page.values.statementMonth : ''
