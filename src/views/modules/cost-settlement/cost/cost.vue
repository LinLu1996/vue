      ...
      <el-row>
        <el-col :span="24" style="text-align: right;padding-right: 5px">
          <el-form-item style="margin-bottom: 5px">
            <el-button type="success" size="mini" icon="el-icon-upload" @click="ticketImportHandle(dataForm.id)">导入</el-button>
            <el-button type="success" size="mini" :disabled="currentStatus !== 0 && currentStatus !== 3" @click="handleExamine(2)">
              <icon-svg name="审核" style="vertical-align: middle"></icon-svg>
              审核</el-button>
            <el-button type="success" size="mini" @click="handleExamine(0)" :disabled="currentStatus !== 2">
              <icon-svg name="反审核" style="vertical-align: middle"></icon-svg>
              反审核</el-button>
            <el-button type="danger" size="mini" @click="handleExamine(4)">
      ...
      <el-table
        ...
        >
          <template slot-scope="scope">
            <el-input-number v-if="scope.row.isEdit===true" :max="9999999" v-model="scope.row.orderOutlay" :precision="2" :step="0.1" size="mini"></el-input-number>
        ...
        <el-table-column
          ...
          show-overflow-tooltip>
          <template slot-scope="scope">
            <el-input-number v-if="scope.row.isEdit===true" :max="9999999" v-model="scope.row.specialOutlay" :precision="2" :step="0.1" size="mini"></el-input-number>
        ...
        <el-table-column
          ...
          label="操作">
          <template slot-scope="scope">
            <el-button v-show="!scope.row.isEdit" type="primary" size="mini" @click="handleEditRow(scope)">
            ...
            <el-button size="mini" type="primary" @click="handleDetail(scope.row.id)">
