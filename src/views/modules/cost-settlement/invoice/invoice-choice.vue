<template>
  ...
  <div class="mod-config">
    <el-form v-if="currentType === 'cost'" ref="dataForm" :model="dataForm" @keyup.enter.native="getDataList()" label-width="100px">
      <el-row>
        <el-col :span="8">
    ...
    <el-form v-if="currentType === 'fine'" ref="dataForm" :model="dataForm" @keyup.enter.native="getDataList()" label-width="100px">
      <el-row>
        <el-col :span="8">
    ...
    <el-form v-if="currentType === 'damage'" ref="dataForm" :model="dataForm" @keyup.enter.native="getDataList()" label-width="100px">
      <el-row>
        <el-col :span="8">
  ...
  export default {
    ...
    methods: {
      ...
      dataFormSubmit () {
        ...
        if (this.currentType === 'cost' && this.selectionDataList.length > 1) {
          this.$message({
            type: 'warning',
            message: '只能选择一条数据'
          })
