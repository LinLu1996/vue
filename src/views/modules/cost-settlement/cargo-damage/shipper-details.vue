...
<!--      </el-table-column>-->
      ...
      <el-table-column
        ...
        <template slot-scope="{row}">
          ...
          <el-input-number v-else v-model="row.cargoDamageAmount" :precision="2" :step="0.1" size="mini"></el-input-number>
        </template>
      </el-table-column>
      <el-table-column
        prop="remark"
      ...
      <el-table-column
        ...
        <template slot-scope="{ row }">
          ...
          <div v-show="row.editing">
            <el-button size="mini" @click="row.editing = false, init()">取消</el-button>
          ...
          if (this.dataForm.id) {
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.cargoDamageMonth = data.fsCargoDamage.cargoDamageMonth
      ...
      outPutExcel () {
        ...
        this.$http({
          ...
          if (window.navigator && window.navigator.msSaveOrOpenBlob) {
            window.navigator.msSaveOrOpenBlob(blob, `${fileName}货主明细.xlsx`);
          } else {
            // for Non-IE (chrome, firefox etc.)
            link.style.display = 'none'
            link.href = URL.createObjectURL(blob);
            link.setAttribute('download', `${fileName}货主明细.xlsx`)
