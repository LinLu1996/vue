...
<!--              <el-option value="1" label="审核中"></el-option>-->
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button type="warning" size="small" @click="showDetails(scope.row.id, scope.row.status)">
    ...
    <cargo-upload ref="addOrUpdate" v-if="dialogVisible" @refreshDataList="getDataList"></cargo-upload>
